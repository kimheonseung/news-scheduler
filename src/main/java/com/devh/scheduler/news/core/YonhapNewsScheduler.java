package com.devh.scheduler.news.core;
...
import com.devh.scheduler.news.entity.NewsLastRead;
import com.devh.scheduler.news.repository.NewsLastReadRepository;
import com.devh.scheduler.news.service.NewsService;
...
public class YonhapNewsScheduler implements IScheduler {
    /* DI */
